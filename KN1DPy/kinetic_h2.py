...
def kinetic_h2(mesh: KineticMesh, mu: int, vxi: NDArray, fH2BC: NDArray, GammaxH2BC: float, NuLoss: NDArray, fH: NDArray = None, 
    ...
    '''
    #NOTE Consider changing returns, make class or some other better output format
    ...
    #NOTE Fix Later
    differentials = VSpace_Differentials(vr, vx)
    ...
    fH2_iterate = 0 
    if (H2_H2_EL != 0) or (H2_HP_CX != 0) or (H2_H_EL != 0) or (H2_P_EL != 0) or ni_correct:
        fH2_iterate=1
    fH2_generations = 0
    if fH2_iterate != 0:
        fH2_generations = 1
